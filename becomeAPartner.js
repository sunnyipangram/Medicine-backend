                 ...
                 <tbody>
                     ...
                     <tr>
                         <td>
                            ...
                            <p style="margin-bottom:5px" >Store Name: ${info.storeName}</p>
                            <p style="margin-bottom:5px" >Location: ${info.location}</p>
                            </div>
                         </td>
                     </tr>
                 </tbody>
